...
//MARK: - functions
    ...
    func downloadImageWithAvatarurl() {
    ...
    func addSubviews() {
        view.addSubviews(avatarImageView,usernameLabel,nameLabel,locationlabel,locationImageView,avatarImageView,bioLabel)
    }
